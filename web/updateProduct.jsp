	...
	<div class="container">
		<div class="row"
			...
			<form action="" method="post"
				...
				style="border: 2px solid black; border-radius: 10px; background-color: #2a2e2b; padding: 10px;">
				<div style="font-weight: bold;" class="text-center" >
					<div class="form-group">
						<img src=""
							alt="Product Image" height="100px" />
						<h2 style="color: white;">Product Update Form</h2>
					</div>
				</div>
				<div class="row">
