...
<%@ page
	import="com.shaji.service.impl.*, com.shaji.service.*,com.shaji.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color:#2a2e2b;">
	...
	<div class="text-center"
		style="color: white; font-size: 24px; font-weight: bold;">Stock
		Products</div>
