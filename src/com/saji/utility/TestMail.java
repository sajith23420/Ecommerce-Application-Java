	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Tech World!</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Tech World<br>"
					...
					+ "<span class='greenText'>SAJIYA500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
